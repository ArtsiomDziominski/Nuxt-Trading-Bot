  ...
  <v-card class="compact-card">
    ...
    <v-card-text>
      <div class="price-section">
        ...
        <span class="value">${{ Number(position.positionRisk.markPrice) }}</span>
      </div>
      <div class="price-section">
      ...
      <div class="price-section">
        ...
        <span class="value">${{ Number(position.positionRisk.entryPrice) }}</span>
      </div>
      <div class="price-section">
    ...
    <v-card-actions class="card-actions">
      <v-btn color="red darken-1" @click="stopBot" outlined>Остановить</v-btn>
      <v-btn color="green darken-1" @click="takeProfit" outlined>Собрать</v-btn>
    </v-card-actions>
  </v-card>
</template>
